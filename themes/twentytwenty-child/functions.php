...
// Copy the following lines in your functions.php theme file if you want to remove
// some particular mime type added by this plugin
...
// add_filter( 'mime_types', function( $wp_get_mime_types ) {
// 	// Optional. Remove a mime type.
